      ...
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="text-zinc-400">
            Continue with Google to access redditprofile
          </p>
        </div>
        ...
        <div className="rounded-xl border border-card-border bg-card-bg p-6">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-card-border bg-background px-4 py-3 text-sm font-medium text-foreground transition-colors hover:border-green-accent/40 hover:bg-card-bg disabled:cursor-not-allowed disabled:opacity-50"
            >
